...
# Getting cycling routes and points
...
### Getting the distance data from transit
...
# Getting transit routes and points
...
# Combining bike and transit data

```{r}
distance_duration_bike$mode <- "bike"
distance_duration_transit$mode <- "transit"

ottawa_fallowfield <- full_join(distance_duration_bike, distance_duration_transit)
