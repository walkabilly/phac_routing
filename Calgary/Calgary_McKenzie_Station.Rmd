...
```{r}
arrival_time <- as.POSIXct("2024-09-24 08:30:00", tz = "America/Calgary")       #### EDIT ME
```

#### List of variables for geocoding

```{r}
var_list <- c("var1", "var2", "var3", "var4", "var5", "var6", "var7", "var8", "var9", "var10", "var11", "var12", "var13", "var14", "var15", "var16", "var17", "var18", "var19", "var20", "var21", "var22", "var23", "var24") #### EDIT ME
```
